...
const ITEM_DB = {
  ...
  consumable: [
    ...
    {name:"蝴蝶兰种子",type:"消耗品",effect:"可播种蝴蝶兰花"},
    {name:"郁金香种子",type:"消耗品",effect:"可播种郁金香"},
    ...
    {name:"小雏菊种子",type:"消耗品",effect:"可播种小雏菊"},
    {name:"绣球花种子",type:"消耗品",effect:"可播种绣球花"},
    {name:"夕颜花种子",type:"消耗品",effect:"可播种夕颜花"},
    {name:"迎春花种子",type:"消耗品",effect:"可播种迎春花"},
    {name:"山茶花种子",type:"消耗品",effect:"可播种山茶花"},
    {name:"蔷薇花种子",type:"消耗品",effect:"可播种蔷薇花"},
    {name:"百合花种子",type:"消耗品",effect:"可播种百合花"},
    {name:"樱花种子",type:"消耗品",effect:"可播种樱花"},
    {name:"杜鹃种子",type:"消耗品",effect:"可播种杜鹃"},
    {name:"水仙种子",type:"消耗品",effect:"可播种水仙"},
    {name:"牡丹种子",type:"消耗品",effect:"可播种牡丹"},
    {name:"铃兰花种子",type:"消耗品",effect:"可播种铃兰花"},
    {name:"玫瑰种子",type:"消耗品",effect:"可播种玫瑰"},
    {name:"风信子种子",type:"消耗品",effect:"可播种风信子"},
...
const FLOWER_DB = {
  ...
  "水仙":{rarity:"普通",stageTime:2,sellPrice:30,edible:false}, "蝴蝶兰":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},
  "山茶花":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},"郁金香":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},
  "夕颜花":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},"小雏菊":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},
  "绣球花":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},"迎春花":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},
  "蔷薇花":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},"风信子":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},
  "百合花":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},"樱花":{rarity:"普通",stageTime:2,sellPrice:30,edible:false},
  "牡丹":{rarity:"稀有",stageTime:4,sellPrice:100,edible:true},"铃兰花":{rarity:"稀有",stageTime:4,sellPrice:100,edible:false},
...
const WORKSHOP_RECIPES = [
  {name:"干花书签",flowerReq:"any2",materials:[],statReq:{花艺:300},sellPrice:0,effect:"任意花两朵制作，收集齐全部花卉解锁群芳图鉴成就",special:"achievement"},
