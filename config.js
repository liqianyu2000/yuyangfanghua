...
// ============ 官职列表（父亲身世用） ============
const OFFICIAL_LIST = [
  "无","太师","太傅","太保","司徒","司空","太子太师","太子太傅","太子太保",
  "尚书令","中书令","侍中","左右仆射","大都督","六部尚书","太子宾客","太常卿","太子詹事","都督","大都护","门下侍郎","中书侍郎",
  "御史大夫","秘书监","光禄卿","卫尉卿","宗正卿","太仆卿","大理卿","鸿胪卿","司农卿","太府卿","散骑常侍","国子祭酒","少府监","将作监","刺史",
  "黄门侍郎","尚书左丞","吏部侍郎","太常少卿","尚书右丞","诸部侍郎",
  "御史中丞","谏议大夫","国子博士","中书舍人","太子中舍人",
  "尚书郎中","太常丞","著作郎","太子洗马",
  "太学博士","起居郎","起居舍人","员外郎","大理司直","通事舍人","秘书郎","侍御史",
  "四门博士","殿中侍御史","太常博士","监察御史",
  "校书郎","太祝","县尉","主簿","知县","参军","无品白身"
];

const MILITARY_LIST = [
  "无","太尉","枢密使","枢密副使","率臣","枢密院事","殿前指挥使","指挥使","殿前公事","殿前虞候","安抚使","镇抚使",
  "马军都指挥使","步军都指挥使","千户","副千户","都虞候","百户",
  "马军指挥使","步军指挥使","副指挥使","总旗","小旗",
  "马军军使","步军都头","提点刑狱","通判",
  "敦武郎","修武郎","从义郎","秉节郎","忠训郎","忠翊郎","成忠郎","保义郎","承节郎","承信郎",
  "进武校尉","进义校尉","进武副尉","白身"
];
